...
| `sttm/pair_4_family_d.xlsx` | STTM D — single mapping sheet | 4 | STTM (meta r1 File Name only; band r4 `Source Data | Data Rules | Target Table - Staging Layer | Target Table - Standard Layer`; headers r5 = 25 cols, `... in Lakehouse`), LOB_CROSSWALK (3), OVERPUNCH_RULES (band r1–r2, headers r3, 2 merges) |
| `sttm/pair_6_family_d.xlsx` | STTM D — single mapping sheet | 6 | Version Control (header r2), Server details (6 environment-group merges), FEED_6_MAPPING (band r2 `Source table | Stage Layer | STD layer`, 3 merges; headers r3 = 22 cols; database-table source) |
